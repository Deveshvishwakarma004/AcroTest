...
import com.acrotest.repos.UserRepo;
...
public class UserService implements UserDetailsService
{
	...
	public User checklogin(@Valid Login model) {
		Optional<User> op = userRepo.findByEmailAndPassword(model.getEmail() , model.getPassword());
		if(op.isPresent())
			return op.get();
		else {
			return null;
